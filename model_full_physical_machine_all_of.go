...
// FullPhysicalMachineAllOf struct for FullPhysicalMachineAllOf
type FullPhysicalMachineAllOf struct {
...
func (o FullPhysicalMachineAllOf) MarshalJSON() ([]byte, error) {
...
type NullableFullPhysicalMachineAllOf struct {
	value *FullPhysicalMachineAllOf
	isSet bool
}

func (v NullableFullPhysicalMachineAllOf) Get() *FullPhysicalMachineAllOf {
	return v.value
}

func (v *NullableFullPhysicalMachineAllOf) Set(val *FullPhysicalMachineAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFullPhysicalMachineAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFullPhysicalMachineAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFullPhysicalMachineAllOf(val *FullPhysicalMachineAllOf) *NullableFullPhysicalMachineAllOf {
	return &NullableFullPhysicalMachineAllOf{value: val, isSet: true}
}

func (v NullableFullPhysicalMachineAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFullPhysicalMachineAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

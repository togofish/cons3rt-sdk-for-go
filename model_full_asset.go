...
// FullAsset struct for FullAsset
...
func (o FullAsset) MarshalJSON() ([]byte, error) {
...
type NullableFullAsset struct {
	value *FullAsset
	isSet bool
}

func (v NullableFullAsset) Get() *FullAsset {
	return v.value
}

func (v *NullableFullAsset) Set(val *FullAsset) {
	v.value = val
	v.isSet = true
}

func (v NullableFullAsset) IsSet() bool {
	return v.isSet
}

func (v *NullableFullAsset) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFullAsset(val *FullAsset) *NullableFullAsset {
	return &NullableFullAsset{value: val, isSet: true}
}

func (v NullableFullAsset) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFullAsset) UnmarshalJSON(src []byte) error {
	v.isSet = true

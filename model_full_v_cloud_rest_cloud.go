...
func NewFullVCloudRestCloud(name string, externalIpSource string, maximumImpactLevel string, subtype string) *FullVCloudRestCloud {
	this := FullVCloudRestCloud{}
	this.Name = name
...
func (o FullVCloudRestCloud) MarshalJSON() ([]byte, error) {
...
type NullableFullVCloudRestCloud struct {
	value *FullVCloudRestCloud
	isSet bool
}

func (v NullableFullVCloudRestCloud) Get() *FullVCloudRestCloud {
	return v.value
}

func (v *NullableFullVCloudRestCloud) Set(val *FullVCloudRestCloud) {
	v.value = val
	v.isSet = true
}

func (v NullableFullVCloudRestCloud) IsSet() bool {
	return v.isSet
}

func (v *NullableFullVCloudRestCloud) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFullVCloudRestCloud(val *FullVCloudRestCloud) *NullableFullVCloudRestCloud {
	return &NullableFullVCloudRestCloud{value: val, isSet: true}
}

func (v NullableFullVCloudRestCloud) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFullVCloudRestCloud) UnmarshalJSON(src []byte) error {
	v.isSet = true
